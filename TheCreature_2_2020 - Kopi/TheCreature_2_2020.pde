...
float eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5; // Man ganger med en kommar tal, så derfor kan det ikke være int, da kommartal skrives med float 
float eyeRightRelativeX = 20  ,  eyeRightRelativeY = 5; //Det sammen her   
